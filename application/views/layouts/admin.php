...
<html lang="en">
    <head>
        ...
        <script src="/dev/lib/form.js"></script>
        <script src="/dev/lib/popper.js"></script>
        <script src="/dev/lib/bootstrap.js"></script>
        <script src="/dev/lib/core.js"></script>
    </head>
